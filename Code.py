...
#Functions declarations
    ...
    row = "| {:10} | {:10} |"
    print("{:-^70}".format("MIS41110 Programming for Analytics"))
    print("{:-^70}".format("Assignment: Group Project"))
    print("{:^70}".format(""))
    print("{:^70}".format(""))
    print("{:^70}".format(""))
    print("{:-^70}".format("Welcome to the Stock Prediction Model"))
    print("{:^70}".format(""))
    print("{:*^70}".format("Team Members"))
    print(row.format("      Sudeshna Acharya         ","        19200065                "))
    print(row.format("        Rupam Dutta            ","        19200489                "))
    print(row.format("       Yash Kashiwala          ","        19200059                "))
    print("*" * 70)
    ...
    while choice1 != "3":
        if choice1 == "1": # Validating Company Name and Date Window                        
            ...
            cmpny_name = input('Please input the Company name : ').upper()
